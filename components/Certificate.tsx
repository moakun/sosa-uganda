...
export function Certificate({ userName, company, date, courseName }: CertificateProps) { return ( <div className="relative w-[800px] h-[600px] bg-white p-8 mx-auto"> {/* Border */} <div className="absolute inset-4 border-4 border-gray-300"></div> <div className="absolute inset-6 border-2 border-gray-300"></div>
